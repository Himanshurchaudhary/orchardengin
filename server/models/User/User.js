...
const User = {
    ...
    // Sirf format check — 6 digit Indian pincode
    const isValidIndianPincode = /^[1-9][0-9]{5}$/.test(trimmed);
    
    if (!isValidIndianPincode) return null;
    
    // Valid hai to city/state unknown return karo
    return { pincode: trimmed, city: 'India', state: 'India' };
},
