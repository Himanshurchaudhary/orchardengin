        ...
        content: [
                    ...
                    body: [[{
                        columns: [
                            logoBase64
                                ...
                                : { text: "Orchard Engine", fontSize: 18, bold: true, color: "#fff", margin: [0, 10, 0, 0] },
                            { text: "", width: "*" },
                            {
                                stack: [
            ...
            /* Footer */
            {
                table: {
                    ...
                    body: [[{
                        columns: [
                            { stack: [{ text: "Orchard Engine", bold: true, fontSize: 11, color: GREEN }, { text: "Thank you for shopping with us!", fontSize: 10, color: "#64748b", margin: [0, 2, 0, 0] }] },
                            { stack: [{ text: "support@theorchardengine.com", fontSize: 10, color: GREEN, alignment: "right" }, { text: "Generated: " + fmtDateTime(new Date()), fontSize: 9, color: "#94a3b8", alignment: "right", margin: [0, 2, 0, 0] }, { text: "Computer-generated receipt · No signature required", fontSize: 9, color: "#94a3b8", alignment: "right" }] },
                        ],
                        fillColor: LGREY,
                        margin: [16, 12, 16, 12],
                    }]],
