  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://theorchardengine.com/user/about" />
      </Helmet>
      ...
      <div className="min-h-screen bg-[#fafaf7] font-sans text-gray-800">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-green-700 via-green-600 to-emerald-500 text-white">
          ...
          <div
            className={`relative max-w-4xl mx-auto px-6 py-24 text-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
              }`}
          >
