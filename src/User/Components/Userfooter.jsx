      ...
      <div className="uf-dark">
        ...
        <div className="uf-bottom">
          ...
          <div className="uf-bottom-phones">
            {[
              { label: 'Working 9:00 – 20:00', num: '+91 80830 42829' },
              { label: '24/7 Support Center', num: '+91 80830 42829' },
            ].map((p) => (
          ...
          <div className="uf-bottom-social">
            ...
            {/* Facebook */}
            <a href="#" className="uf-social-btn" style={{ background: '#1877f2', width: 32, height: 32 }}>
            ...
            {/* Instagram */}
            <a href="#" className="uf-social-btn" style={{ background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fd5949 45%, #d6249f 60%, #285AEB 90%)', width: 32, height: 32 }}>
            ...
            {/* WhatsApp */}
            <a href="#" className="uf-social-btn" style={{ background: '#25d366', width: 32, height: 32 }}>
              <svg viewBox="0 0 24 24" fill="white" width="15" height="15">
